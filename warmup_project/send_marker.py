...
class SimpleVisualizationPublisher(Node):
    def __init__(self):
        ...
        )  # create publisher for the Marker class

        timer_period = 0.1  # seconds
        self.timer = self.create_timer(
            timer_period, self.publish_marker
        )  # create a timer which publishes a message every time_period.
    ...
    def publish_marker(self):
        ...
        marker.color.r = 255.00
        marker.color.g = 100.00
        marker.color.b = 0.0
