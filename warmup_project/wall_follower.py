...
class WallFollow(Node):
    def __init__(self):
        ...
        self.laser_sub = self.create_subscription(
            LaserScan, "scan", callback=self.get_data, qos_profile=10
        )
    ...
    def get_data(self, msg):
        ...
        self.dists = {
            "deg45": msg.ranges[45],
            "deg90": msg.ranges[90],
            "deg135": msg.ranges[135],
        }
        self.dists["pcnt_error"] = (
            self.dists["deg45"] - sqrt(2) * self.dists["deg90"]
        ) / (sqrt(2) * self.dists["deg90"])
